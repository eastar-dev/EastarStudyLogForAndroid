...
abstract class BindingViewArrayAdapter<B : ViewDataBinding, VD: Any> @JvmOverloads constructor(@LayoutRes layoutResId: Int, objects: MutableList<VD> = mutableListOf())
    : ArrayAdapter<Holder<B>, VD>(layoutResId, objects) {
