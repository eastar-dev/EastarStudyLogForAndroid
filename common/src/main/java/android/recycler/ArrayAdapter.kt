...
@Suppress("unused")
abstract class ArrayAdapter<VH : RecyclerView.ViewHolder, VD> @JvmOverloads constructor(@LayoutRes val layoutId: Int, protected val objects: MutableList<VD> = mutableListOf()) :
