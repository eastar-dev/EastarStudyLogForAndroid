...
open class DiffBindingDataArrayAdapter @JvmOverloads constructor(private vararg var diffTypes: DiffBindingDataType, objects: MutableList<Any> = mutableListOf()) :
    BindingViewArrayAdapter<ViewDataBinding, Any>(0, objects) {
