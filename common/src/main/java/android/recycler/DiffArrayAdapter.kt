...
abstract class DiffArrayAdapter @JvmOverloads constructor(private vararg var diffTypes: DiffType, objects: MutableList<Any> = mutableListOf()) :
    ArrayAdapter<DiffHolder<Any>, Any>(0, objects) {
